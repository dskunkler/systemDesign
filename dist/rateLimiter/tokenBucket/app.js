...
var app = express();
var cache = new NodeCache({ stdTTL: process.env.TTL }); // This could be a redis cache for a distributed system
// These next two variables could be stored in azure configs and stored in a cache as well
var bucketSize = process.env.BUCKET_SIZE; // Here we could import some rule through Azure config's
var bucketRefreshRate = process.env.BUCKET_SIZE; // milliseconds. This could also be imported through azure configs as a rule
